-- ============================================================
-- STORED PROCEDURE getVentasListWithPage — agrega fechaEntrega e
-- idUserEntrega al resultado, y el mismo sufijo visual "Entregado"
-- que ya usa taller cuando un apartado (idSaleType=3) fue entregado.
-- Redefinición completa (no versionada previamente en este repo,
-- capturada desde la BD en vivo) — el resto del procedimiento queda
-- IDÉNTICO al original, solo se tocan las líneas marcadas.
-- ============================================================
...
SET SESSION TRANSACTION ISOLATION LEVEL READ UNCOMMITTED;
    ...
    AND S.idSaleType NOT IN( 5 ) -- QUE NO SEA DE TALLER
	AND
	(
		(
			p_bCancel = 1
